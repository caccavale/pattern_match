from tokenize import tokenize, STRING, NAME, OP, NL, NEWLINE
...
'''
    ...
    usage:
        - in the main project file do 'import pattern_match.pattern_match'
        - modules imported after with '# coding: pattern_match' can use pattern matching
